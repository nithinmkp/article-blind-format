...
\hypersetup{
  pdftitle={The Excess Sensitivity of Consumption to Sentiments: Does the PIH hold for India?},
  pdfauthor={Nithin.M; Dr.~Siddhartha Chattopadhyay; Dr.~Sohini Sahu},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\title{The Excess Sensitivity of Consumption to Sentiments: Does the PIH
hold for India?\thanks{Authors would like to thank Ms.~Monami Mitra,
Director, Price Statistics Division, National Statistical Office,
Government of India}}
...
Sciences,   % Department, followed by a comma if institution is present
  IIT Kharagpur  % Institution name
  }
\author{
